...
enum SortOptions { nameAsc, nameDesc }
...
class _HomePageState extends State<HomePage> {
          ...
          PopupMenuButton<SortOptions>(
            itemBuilder: (context) => <PopupMenuEntry<SortOptions>>[
              const PopupMenuItem<SortOptions>(
                child: Text("SortBy Name : A-Z"),
                value: SortOptions.nameAsc,
              ),
              const PopupMenuItem<SortOptions>(
                child: Text("SortBy Name : Z-A"),
  ...
  void _showContactPage({Contact contact}) async {
    final recContact =
        await Navigator.push(context, MaterialPageRoute(builder: (context) => ContactPage(contact: contact)));
    if (recContact != null) {
      if (contact != null) {
